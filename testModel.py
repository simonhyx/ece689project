...
def generateXY2(num_variables = 3, constant_low=0, constant_high=100, t_span = np.linspace(0, 10000, 100*10000)):
...
def generateXY3(num_variables = 3, constant_low=0, constant_high=100, t_span = np.linspace(0, 10000, 100*10000)):
...
def generateXY4(num_variables = 3, constant_low=0, constant_high=100, t_span = np.linspace(0, 10000, 100*10000)):
    success = False
    x = 0
    y = 0
    while not success:  
...
def generateXY5(num_variables = 3, constant_low=0, constant_high=100, t_span = np.linspace(0, 10000, 100*10000)):
    success = False
    x = 0
    y = 0
    while not success:  
