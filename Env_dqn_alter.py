...
class controlEnv():
    def __init__(self, df, allowed_genes_to_be_perturbed, target_state):
    ...
    def getObsAndReward(self, action):
        ...
        sol = solve_ivp(self.diffEqv2, (0, 2*3600), self.currentData.reshape(self.currentData.shape[1],), method = 'LSODA')
        #print(sol.y.shape)
